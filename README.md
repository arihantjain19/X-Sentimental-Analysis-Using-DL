# X-Sentiment-Analysis using Deep Learning
...
# Posts Preprocessing and Cleaning
...
In one of the later stages, we will be extracting numeric features from our X text data. This feature space is created using all the unique words present in the entire data. So, if we preprocess our data well, then we would be able to get a better quality feature space.
